...
import { subcontractorPortalApiFetch } from "@/lib/subcontractor-portal-api-client";

export default function SubcontractorPortalLoginPage() {
  ...
  async function requestLink(e: React.FormEvent) {
    ...
    setBusy(true);
    try {
      await subcontractorPortalApiFetch("/subcontractor-portal/auth/request-link", {
        method: "POST",

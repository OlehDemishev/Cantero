 ...
 *
 * companyName/estimateName/title are tenant-controlled free text (only length-limited by their
 * Zod schema, not HTML-sanitized) — each function escapes them before building `html` so a
 * company or estimate named e.g. `<img src=x onerror=...>` can't inject markup into a client's
 * inbox. `number`/`total`/`currency`/`link` are server-generated, not escaped. */
  ...
  switch (locale) {
    case "de":
      return {
        ...
        html: `<p>${safeCompanyName} hat Ihnen die Rechnung <strong>${number}</strong> über ${total} ${currency} gesendet.</p><p>Die Rechnung ist als PDF angehängt.</p>`,
    ...
    case "es":
      return {
        ...
        html: `<p>${safeCompanyName} le ha enviado la factura <strong>${number}</strong> por ${total} ${currency}.</p><p>La factura se adjunta en PDF.</p>`,
    ...
    case "pl":
      return {
        ...
        html: `<p>${safeCompanyName} przesłał(a) Ci fakturę <strong>${number}</strong> na kwotę ${total} ${currency}.</p><p>Faktura jest załączona w formacie PDF.</p>`,
    ...
    case "uk":
      return {
        ...
        html: `<p>${safeCompanyName} надіслав(-ла) вам рахунок <strong>${number}</strong> на суму ${total} ${currency}.</p><p>Рахунок додано у форматі PDF.</p>`,
    ...
    default:
      return {
        ...
        html: `<p>${safeCompanyName} has sent you invoice <strong>${number}</strong> for ${total} ${currency}.</p><p>The invoice is attached as a PDF.</p>`,
...
export function estimateSentEmail(locale: Locale, companyName: string, estimateName: string, link: string): EmailBody {
  const safeCompanyName = escapeHtml(companyName);
  const safeEstimateName = escapeHtml(estimateName);
  switch (locale) {
    case "de":
      return {
        subject: `Kostenvoranschlag von ${companyName}: ${estimateName}`,
        html: `<p>${safeCompanyName} hat Ihnen einen Kostenvoranschlag zur Prüfung gesendet: <strong>${safeEstimateName}</strong>.</p><p><a href="${link}">Kostenvoranschlag ansehen und beantworten</a></p>`,
    ...
    case "es":
      return {
        ...
        html: `<p>${safeCompanyName} le ha enviado un presupuesto para su revisión: <strong>${safeEstimateName}</strong>.</p><p><a href="${link}">Ver y responder al presupuesto</a></p>`,
    ...
    case "pl":
      return {
        ...
        html: `<p>${safeCompanyName} przesłał(a) Ci kosztorys do przeglądu: <strong>${safeEstimateName}</strong>.</p><p><a href="${link}">Zobacz i odpowiedz na kosztorys</a></p>`,
    ...
    case "uk":
      return {
        ...
        html: `<p>${safeCompanyName} надіслав(-ла) вам кошторис для розгляду: <strong>${safeEstimateName}</strong>.</p><p><a href="${link}">Переглянути та відповісти на кошторис</a></p>`,
    ...
    default:
      return {
        ...
        html: `<p>${safeCompanyName} has sent you an estimate for review: <strong>${safeEstimateName}</strong>.</p><p><a href="${link}">View and respond to the estimate</a></p>`,
  ...
  switch (locale) {
    case "de":
      return {
        ...
        html: `<p>${safeCompanyName} hat Ihnen einen Nachtrag zur Prüfung gesendet: <strong>${safeTitle}</strong>.</p><p><a href="${link}">Nachtrag ansehen und beantworten</a></p>`,
    ...
    case "es":
      return {
        ...
        html: `<p>${safeCompanyName} le ha enviado una orden de cambio para su revisión: <strong>${safeTitle}</strong>.</p><p><a href="${link}">Ver y responder a la orden de cambio</a></p>`,
    ...
    case "pl":
      return {
        ...
        html: `<p>${safeCompanyName} przesłał(a) Ci zlecenie zmiany do przeglądu: <strong>${safeTitle}</strong>.</p><p><a href="${link}">Zobacz i odpowiedz na zlecenie zmiany</a></p>`,
    ...
    case "uk":
      return {
        ...
        html: `<p>${safeCompanyName} надіслав(-ла) вам наряд-замовлення для розгляду: <strong>${safeTitle}</strong>.</p><p><a href="${link}">Переглянути та відповісти на наряд-замовлення</a></p>`,
    ...
    default:
      return {
        ...
        html: `<p>${safeCompanyName} has sent you a change order for review: <strong>${safeTitle}</strong>.</p><p><a href="${link}">View and respond to the change order</a></p>`,

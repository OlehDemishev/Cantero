...
export class CustomFieldsService {
  ...
  async getValues(companyId: string, entityType: CustomFieldEntityType, entityId: string) {
    await this.assertEntity(companyId, entityType, entityId);
  ...
  async setValues(companyId: string, entityType: CustomFieldEntityType, entityId: string, input: SetCustomFieldValuesInput) {
    await this.assertEntity(companyId, entityType, entityId);
    ...
    return this.getValues(companyId, entityType, entityId);
  }

  private async assertEntity(companyId: string, entityType: CustomFieldEntityType, entityId: string) {
    const exists =
      entityType === "project"

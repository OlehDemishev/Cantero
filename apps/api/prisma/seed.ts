...
const metricMaterials: MaterialSeed[] = [
...
const metricRateItems: RateItemSeed[] = [
  {
    code: "RC-TILE-FLOOR",
...
const imperialMaterials: MaterialSeed[] = [
...
const imperialRateItems: RateItemSeed[] = [
  {
    code: "RC-TILE-FLOOR",
    name: "Lay ceramic floor tile",
    unit: "sqft",
